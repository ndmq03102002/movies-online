                        ...
                        <a href="{{ route('movie', $mov->slug) }}">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__pic set-bg" data-setbg="{{ $mov->image }}" alt="{{ $mov->name }}" loading="lazy">
                                    @else
                                    <div class="product__item__pic set-bg" data-setbg="{{ asset('uploads/movie/' . $mov->image) }}" alt="{{ $mov->name }}" loading="lazy">
                                    @endif
