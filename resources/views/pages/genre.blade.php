        ...
        <div class="row">
            <div class="col-lg-8">
                          ...
                          <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                              ...
                              <div
                                ...
                                data-setbg="{{$mov->image}}" alt="{{ $mov->name }}" loading="lazy "  style="background-repeat: no-repeat; background-size: cover; background-position: top center;"
                              >
                              @else
                ...
                <div class="product__pagination">
                  ...
                  @else
                      <a href="{{ $movies->previousPageUrl() }}"><i class="fa fa-angle-double-left"></i></a>
                  @endif
                  ...
                  @if ($movies->hasMorePages())
                      <a href="{{ $movies->nextPageUrl() }}"><i class="fa fa-angle-double-right"></i></a>
                  @else
